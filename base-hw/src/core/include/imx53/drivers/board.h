...
#ifndef _INCLUDE__IMX53__DRIVERS__BOARD_H_
#define _INCLUDE__IMX53__DRIVERS__BOARD_H_

/**
 * Genode includes
 */
#include <platform/imx53/drivers/board.h>
#include <util/mmio.h>
...
typedef Imx53::Board Board;

#endif /* _INCLUDE__IMX53__DRIVERS__BOARD_H_ */
